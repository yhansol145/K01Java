...
public class E05For {
	...
	public static void main(String[] args) {
		...
		/*
		시나리오] 1~100까지의 합을 구하는 프로그램을 for문
			이용하여 구현하시오.
		 */
		int sum = 0;
		for(int j=1 ; j<=100 ; j++) {
		...
		/*
		시나리오] for문을 이용하여 1~10사이의 정수중 2의배수의 합을 구하는
		프로그램을 작성하시오
		 */
		...
		System.out.println("1~10사이 2의배수의 합:");
...
//		}
		...
		메모리에서 소멸된다. 여기서 사용한 변수 j는 지역변수(local variable)
		라고 한다. 지역변수는 해당지역을 벗어나면 즉시 소멸하는 특징을 갖고있다
		 */
