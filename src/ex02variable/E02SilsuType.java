...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		/*
		실수자료형
		- 정수형보다는 실수형이 더 큰 자료형이다. (0과1사이에 무수히 많은
		실수가 존재하기 때문)
		...
		//float f4 = 3.14; -> 에러발생 (3.14 자체를 double형으로 인식)
		float f4 = (float)3.14; //형변환후 대입 가능(권장사항은 아님)
		System.out.println("f4="+ f4);
		
		float f5 = 3.14F; //접미사 F를 통해 float임을 표현한다.
		...
		double d1 = 3.14;
		double d2 = f6 + d1; //float + double = double(큰쪽을따라감)
